...
for(var x of buttons){
    x.addEventListener("click", function(){
        ...
        if(answer == "Rock" && this.innerHTML == 'Rock <i class="fa-solid fa-hand-back-fist"></i>'){
            var answerRock = answerWas.innerHTML = (`Opponent chose ROCK <i class="fa-solid fa-hand-back-fist"></i>`)
        ...
        if(answer == "Paper" && this.innerHTML == 'Rock <i class="fa-solid fa-hand-back-fist"></i>'){
            var answerPaper = answerWas.innerHTML = (`Opponent chose PAPER <i class="fa-solid fa-hand-back-fist"></i>`)
        ...
        if(answer == "Scissors" && this.innerHTML == 'Rock <i class="fa-solid fa-hand-back-fist"></i>'){
            var answerScissors = answerWas.innerHTML = (`Opponent chose SCISSORS <i class="fa-solid fa-hand-back-fist"></i>`)
